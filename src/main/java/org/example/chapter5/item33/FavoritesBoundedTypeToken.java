...
public class FavoritesBoundedTypeToken {



	// 타입 토큰을 키로 가지는 맵 인스턴스
	// 즐겨찾기를 추가하거나 조회할 수 있음
	private Map<Class<? extends Number>, Object> favorites = new HashMap<>(); // -> 타입 안전성을 보장하나?
	...
	public <T extends Number> void putFavorites(Class<T> type, T instance){
...
//	@SuppressWarnings("unchecked") ->
	public <T extends Number> T getFavorites(Class<T> type){
